		...
		<div v-if="!isMobile" class="nav">
			<div class="nav-content">
				<el-row :gutter="20">
					...
					<el-col :span="5" v-if="userInfo._id">
						<div class="nav-right">
							<el-dropdown @command="handleLogout">
								...
								<img v-if="!userInfo.avatar" src="../assets/logo.png" alt class="user-img" />
								<img v-else :src="userInfo.avatar" alt class="user-img" />
		...
		<div v-else class="nav">
			<div class="nav-mobile">
				<div class="nav-mobile-logo">
					<img src="../assets/logo.png" alt class="logo fl" />
				</div>
			...
			>
				<div class="list">
					...
					<div v-if="!userInfo._id" class="item" @click="handleClickMenu('/register')">注册</div>
					<div v-if="userInfo._id" class="item" @click="handleClickMenu('/logout')">登出</div>
				</div>
			</div>
		</div>
		<!--  -->
...
<script lang='ts'>
	...
	export default class Nav extends Vue {
		...
		private list: Array<NavListItem> = [
			{ index: "1", path: "/", name: "首页" },
			{ index: "2", path: "/articles", name: "文章" },
			{ index: "3", path: "/archive", name: "归档" },
			{ index: "4", path: "/project", name: "项目" },
			{ index: "5", path: "/timeline", name: "历程" },
			{ index: "6", path: "/message", name: "留言" },
			{ index: "7", path: "/about", name: "关于" }
		];
